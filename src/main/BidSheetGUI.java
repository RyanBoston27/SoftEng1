...
public class BidSheetGUI {
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 450, 611);
		...
		lblNewLabel_4.setBounds(264, 26, 34, 14);
		...
		separator1.setBounds(0, 106, 435, 2);
		...
		lblApproxFt1.setBounds(212, 114, 86, 14);
		frame.getContentPane().add(lblApproxFt1);
		
		JLabel lblDrop = new JLabel("Drop:  ");
		lblDrop.setBounds(365, 114, 34, 14);
		...
		lblAddHorFt.setBounds(209, 139, 134, 14);
		...
		separator_2.setBounds(0, 188, 435, 2);
		...
		separator2.setBounds(0, 236, 435, 2);
		...
		lblTranLiner.setBounds(93, 275, 81, 14);
		...
		textArea.setBounds(6, 421, 418, 107);
		...
		separator3.setBounds(0, 394, 435, 2);
		...
		txtName.setBounds(88, 3, 173, 20);
		frame.getContentPane().add(txtName);
		txtName.setColumns(10);
		
		txtEmail = new JTextField();
		txtEmail.setBounds(88, 23, 173, 20);
		frame.getContentPane().add(txtEmail);
		txtEmail.setColumns(10);
		
		txtJobAdd = new JTextField();
		txtJobAdd.setBounds(88, 43, 336, 20);
		frame.getContentPane().add(txtJobAdd);
		txtJobAdd.setColumns(10);
		
		txtDate = new JTextField();
		txtDate.setBounds(301, 3, 123, 20);
		frame.getContentPane().add(txtDate);
		txtDate.setColumns(10);
		
		txtPhone = new JTextField();
		txtPhone.setBounds(301, 23, 123, 20);
		frame.getContentPane().add(txtPhone);
		txtPhone.setColumns(10);
		
		txtBillAdd = new JTextField();
		txtBillAdd.setBounds(88, 63, 336, 20);
		...
		rdbtn2.setBounds(159, 148, 35, 14);
		...
		chckPropLine.setBounds(91, 159, 97, 23);
		...
		rdbtn6.setBounds(159, 207, 35, 14);
		...
		btnSub.setBounds(159, 538, 117, 23);
